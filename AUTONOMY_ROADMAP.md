...
- [ ] `RedissonAutonomyLedger` + `ledger.type=redisson`
- [ ] Micrometer：`ms.autonomy.run.total`、`ms.autonomy.mttr`
- [ ] 控制台 STABLE 事件展示 MTTR

### Phase 3 — MQ 场景 + 采纳推荐（1 周）
...
com.ms.middleware.autonomy/
  ...
  ├── run/          # AutonomyLedger + InMemoryAutonomyLedger
